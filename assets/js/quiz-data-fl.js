...
'ujian-akhir': {
  ...
  kode: 'UJIAN',
  config: { beginner: 3, intermediate: 8, expert: 4 },
  pool: [

/* ──── BEGINNER (8 soal) ──── */
{ level:'beginner', type:'mma', q:'Untuk $f(x)=2x-4$, manakah yang benar?',
  opts:['$f(2)=0$','$f(0)=-4$','Grafik naik ke kanan','Titik potong sumbu-$x$ di $(2,0)$','$f(-1)=-6$'],
  jawabArr:[0,1,2,3,4],
  p:'$f(2)=0$ ✓, $f(0)=-4$ ✓, $m=2>0$ ✓, $x$-int di $(2,0)$ ✓, $f(-1)=-2-4=-6$ ✓. Semua benar.' },

{ level:'beginner', type:'bs',
...
{ level:'beginner', type:'pg', q:'Jika $f(x)=ax+b$, $f(1)=5$, dan $f(3)=11$, maka $a+b=$...',
  opts:['5','6','7','8'], jawab:0,
  p:'$a+b=5$ dan $3a+b=11$. $2a=6\\Rightarrow a=3, b=2$. $a+b=5$.' },

{ level:'beginner', type:'bs', q:'Garis $ax+by=c$ dengan $b\\neq0$ memiliki gradien $-\\dfrac{a}{b}$.',
  jawab:'BENAR',
  p:'$by=-ax+c\\Rightarrow y=-\\frac{a}{b}x+\\frac{c}{b}$. Gradien $=-\\frac{a}{b}$ ✓.' },

{ level:'beginner', type:'pg', q:'Jika $f(0)=-2$ dan $f(1)=1$, maka $f(4)=$...',
  opts:['7','8','10','12'], jawab:2,
  p:'$m=3, b=-2$. $f(x)=3x-2$. $f(4)=10$.' },

{ level:'beginner', type:'pg', q:'Gradien garis $y=6x-4$ adalah...',
  opts:['$-4$','$4$','$6$','$-6$'], jawab:2,
  p:'Dalam $y=mx+c$, koefisien $x$ adalah gradien. Maka $m=6$.' },

{ level:'beginner', type:'pg', q:'Nilai $f(2)$ untuk $f(x)=3x-7$ adalah...',
  opts:['$-1$','$1$','$3$','$13$'], jawab:0,
  p:'$f(2)=3(2)-7=6-7=-1$.' },

{ level:'beginner', type:'bs', q:'Titik $(3,4)$ terletak pada garis $y=2x-1$.',
  jawab:'SALAH',
  p:'$y(3)=2(3)-1=5\\neq4$. Titik $(3,4)$ tidak berada pada garis $y=2x-1$.' },

/* ──── INTERMEDIATE (16 soal) ──── */
{ level:'intermediate', type:'pg', q:'Gradien garis yang melalui $(-1,4)$ dan $(3,-4)$ adalah...',
  opts:['$-2$','$2$','$-\\frac{1}{2}$','$\\frac{1}{2}$'],
  jawab:0, p:'$m=\\frac{-4-4}{3-(-1)}=\\frac{-8}{4}=-2$.' },

{ level:'intermediate', type:'pg', q:'Persamaan garis yang sejajar $2x-y+5=0$ dan melalui $(3,1)$ adalah...',
  opts:['$y=2x-5$','$y=2x+5$','$2x+y-5=0$','$y=-2x+7$'],
  jawab:0, p:'$m=2$. $y-1=2(x-3)\\Rightarrow y=2x-5$.' },

{ level:'intermediate', type:'bs',
...
{ level:'intermediate', type:'pg', q:'Titik potong garis $3x+2y=12$ dan $x-y=1$ adalah...',
  opts:['$(2,3)$','$(3,\\frac{3}{2})$','$(\\frac{14}{5},\\frac{9}{5})$','$(4,0)$'],
  jawab:2, p:'$x=y+1$: $3(y+1)+2y=12\\Rightarrow 5y=9\\Rightarrow y=\\frac{9}{5}$, $x=\\frac{14}{5}$.' },

{ level:'intermediate', type:'pg', q:'Garis tegak lurus terhadap $y=\\frac{3}{4}x-2$ memiliki gradien...',
  opts:['$\\frac{3}{4}$','$-\\frac{4}{3}$','$\\frac{4}{3}$','$-\\frac{3}{4}$'],
  jawab:1, p:'$m_\\perp=-\\frac{4}{3}$.' },

{ level:'intermediate', type:'pg', q:'Biaya $C(x)=5000x+200000$. Jumlah unit agar $C=700000$ adalah...',
  opts:['80','90','100','110'], jawab:2,
  p:'$5000x+200000=700000\\Rightarrow 5000x=500000\\Rightarrow x=100$.' },

{ level:'intermediate', type:'mma', q:'Manakah garis yang tegak lurus dengan $y=3x-1$?',
  opts:['$y=-\\frac{1}{3}x+2$','$y=3x+5$','$3y=-x+6$','$y=-\\frac{1}{3}x$','$x+3y=7$'],
  jawabArr:[0,2,3,4],
  p:'Tegak lurus: $m=-\\frac{1}{3}$. A: $m=-\\frac{1}{3}$ ✓. B: $m=3$ ✗. C: $y=-\\frac{1}{3}x+2$ ✓. D: $m=-\\frac{1}{3}$ ✓. E: $3y=-x+7\\Rightarrow y=-\\frac{1}{3}x+\\frac{7}{3}$ ✓.' },

{ level:'intermediate', type:'pg', q:'Daerah $y>2x-3$, titik mana yang termasuk?',
  opts:['$(0,-4)$','$(2,0)$','$(1,5)$','$(3,1)$'],
  jawab:2, p:'$(1,5)$: $5>2-3=-1$ ✓.' },

{ level:'intermediate', type:'mma', q:'Manakah yang merupakan sifat dua garis sejajar?',
  opts:['Gradien sama','Tidak berpotongan','$y$-intercept berbeda','Dapat berpotongan di satu titik','Jarak antara keduanya konstan'],
  jawabArr:[0,1,2,4],
  p:'Gradien sama ✓, tidak berpotongan ✓, $y$-int berbeda ✓, tidak dapat berpotongan ✗, jarak antara keduanya konstan ✓.' },

{ level:'intermediate', type:'pg', q:'Persamaan garis yang melalui $(1,2)$ dan $(3,8)$ adalah...',
  opts:['$y=3x-1$','$y=3x+1$','$y=3x+2$','$y=2x$'],
  jawab:0,
  p:'$m=\\frac{8-2}{3-1}=3$. $y-2=3(x-1)\\Rightarrow y=3x-1$.' },

{ level:'intermediate', type:'pg', q:'Nilai $k$ agar garis $kx+2y=6$ sejajar $y=3x-1$ adalah...',
  opts:['$-6$','$-3$','$3$','$6$'], jawab:0,
  p:'Gradien $y=3x-1$ adalah 3. $kx+2y=6\\Rightarrow y=-\\frac{k}{2}x+3$. $-\\frac{k}{2}=3\\Rightarrow k=-6$.' },

{ level:'intermediate', type:'pg', q:'Sistem $2x+y=7$ dan $x-y=2$ menghasilkan nilai $x=$...',
  opts:['$2$','$3$','$4$','$5$'], jawab:1,
  p:'Jumlahkan kedua persamaan: $3x=9\\Rightarrow x=3$.' },

{ level:'intermediate', type:'bs',
  pernyataan:['Sistem $2x+y=5$ dan $4x+2y=10$ memiliki tak hingga penyelesaian.','Sistem $x+y=3$ dan $x+y=5$ tidak memiliki penyelesaian.','Gradien garis melalui $(a,b)$ dan $(b,a)$ dengan $a\\neq b$ adalah $-1$.'],
  jawabArr:['BENAR','BENAR','BENAR'],
  q:'Tentukan benar atau salah setiap pernyataan berikut.',
  jawab:'BENAR',
  p:'A: Persamaan 2 adalah 2× persamaan 1 → berimpit ✓. B: Garis sejajar, tidak ada solusi ✓. C: $m=\\frac{a-b}{b-a}=-1$ ✓.' },

{ level:'intermediate', type:'mma', q:'Manakah persamaan garis yang melalui titik $(2,3)$?',
  opts:['$y=x+1$','$y=2x-1$','$y=-x+5$','$y=3x$','$y=x-1$'],
  jawabArr:[0,1,2],
  p:'A: $2+1=3$ ✓. B: $4-1=3$ ✓. C: $-2+5=3$ ✓. D: $3(2)=6\\neq3$ ✗. E: $2-1=1\\neq3$ ✗.' },

{ level:'intermediate', type:'pg', q:'Fungsi $f(x)=2x+1$ dan $g(x)=4-x$ berpotongan di titik...',
  opts:['$(1,3)$','$(2,5)$','$(1,4)$','$(3,7)$'], jawab:0,
  p:'$2x+1=4-x\\Rightarrow 3x=3\\Rightarrow x=1, y=3$.' },

{ level:'intermediate', type:'pg', q:'Penyelesaian $|x-2|<3$ adalah...',
  opts:['$-1<x<5$','$x<-1$ atau $x>5$','$-3<x<3$','$0<x<5$'], jawab:0,
  p:'$|x-2|<3\\Rightarrow -3<x-2<3\\Rightarrow -1<x<5$.' },

/* ──── EXPERT (8 soal) ──── */
{ level:'expert', type:'pg', q:'Persamaan garis melalui titik potong $y=x+2$ dan $y=3x-4$ dengan gradien $\\frac{1}{2}$ adalah...',
  opts:['$y=\\frac{1}{2}x+2$','$y=\\frac{1}{2}x-\\frac{1}{2}$','$y=\\frac{1}{2}x+1$','$y=\\frac{1}{2}x+\\frac{7}{2}$'],
  jawab:3,
  p:'Titik potong: $x+2=3x-4\\Rightarrow 2x=6\\Rightarrow x=3, y=5$. Garis: $y-5=\\frac{1}{2}(x-3)\\Rightarrow y=\\frac{1}{2}x+\\frac{7}{2}$.' },

{ level:'expert', type:'pg', q:'Tiga garis $x+y=5$, $2x-y=4$, dan $ax+3y=9$ bertemu di satu titik. Nilai $a$ adalah...',
  opts:['$1$','$2$','$3$','$4$'], jawab:0,
  p:'$x+y=5$ dan $2x-y=4$: $3x=9\\Rightarrow x=3, y=2$. Substitusi ke $ax+3y=9$: $3a+6=9\\Rightarrow a=1$.' },

{ level:'expert', type:'pg', q:'Nilai minimum $Z=3x+3y$ dengan kendala $2x+y\\geq6$, $x+2y\\geq6$, $x,y\\geq0$ adalah...',
  opts:['$6$','$9$','$12$','$18$'], jawab:2,
  p:'Titik pojok: $(0,6)$: $Z=18$. $(6,0)$: $Z=18$. Perpotongan $2x+y=6$ dan $x+2y=6$: $x=2, y=2$. $Z(2,2)=12$. Minimum $Z=12$.' },

{ level:'expert', type:'pg', q:'Nilai $k$ agar sistem $3x+ky=12$ dan $kx+3y=12$ memiliki banyak penyelesaian adalah...',
  opts:['$-3$','$1$','$3$','$9$'], jawab:2,
  p:'Agar berimpit: $\\frac{3}{k}=\\frac{k}{3}\\Rightarrow k^2=9\\Rightarrow k=3$ (kedua persamaan identik ✓). $k=-3$ menghasilkan sistem inkonsisten.' },

{ level:'expert', type:'pg', q:'Bayangan garis $y=2x-3$ terhadap sumbu-$y$ adalah...',
  opts:['$y=2x+3$','$y=-2x+3$','$y=-2x-3$','$y=2x-3$'], jawab:2,
  p:'Refleksi terhadap sumbu-$y$: $(x,y)\\rightarrow(-x,y)$. Substitusi: $y=2(-x)-3=-2x-3$.' },

{ level:'expert', type:'pg', q:'Garis $L_1$ melalui $(1,3)$ bergradien 2. $L_2\\perp L_1$ dan melalui $(5,1)$. Titik potong $L_1$ dan $L_2$ adalah...',
  opts:['$(1,3)$','$(3,7)$','$(5,1)$','$(2,5)$'], jawab:0,
  p:'$L_1$: $y=2x+1$. $L_2$: $m=-\\frac{1}{2}$, $y-1=-\\frac{1}{2}(x-5)\\Rightarrow y=-\\frac{1}{2}x+\\frac{7}{2}$. Perpotongan: $x=1, y=3$.' },

{ level:'expert', type:'pg', q:'Persamaan garis melalui titik potong $y=2x-3$ dan $y=-x+6$ dengan gradien $-2$ adalah...',
  opts:['$y=-2x+9$','$y=-2x+3$','$y=-2x+6$','$y=-2x+1$'], jawab:0,
  p:'Titik potong: $2x-3=-x+6\\Rightarrow 3x=9\\Rightarrow x=3, y=3$. Garis: $y-3=-2(x-3)\\Rightarrow y=-2x+9$.' },

{ level:'expert', type:'pg', q:'Program linear: $Z=5x+4y$, kendala $2x+y\\leq10$, $x+2y\\leq8$, $x,y\\geq0$. Nilai maksimum $Z$ adalah...',
  opts:['$25$','$26$','$28$','$30$'], jawab:2,
  p:'Titik pojok: $(5,0)$: $Z=25$. $(0,4)$: $Z=16$. Perpotongan $2x+y=10$ dan $x+2y=8$: $x=4, y=2$. $Z(4,2)=28$. Maksimum $Z=28$.' },
